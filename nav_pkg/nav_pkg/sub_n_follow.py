    ...
    try:   
        while rclpy.ok():
            ...
            if node.nav_msg.data == "point1":
                ...
                rgoal.pose.position.x = 2.2
                rgoal.pose.position.y = 0.74
                ...
                rgoal.header.stamp.nanosec = 0
                rgoal.pose.position.z = 0.0
                rgoal.pose.position.x = 2.1
                rgoal.pose.position.y = -0.45
                rgoal.pose.orientation.w = 1.0
                ...
                rgoal.header.stamp.nanosec = 0
                rgoal.pose.position.z = 0.0
                rgoal.pose.position.x = 0.5
                rgoal.pose.position.y = 1.2
                rgoal.pose.orientation.w = 1.0
